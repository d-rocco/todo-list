...
function submitProject() {
  ...
  const existingProjectNames = _projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].projects.map(
  ...
  if (
    ...
    const addedProject = (0,_project__WEBPACK_IMPORTED_MODULE_1__["default"])(
      textInput.value,
      (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(), "MMM dd, yyyy")
    );
    _projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].projects.push(addedProject);
    _projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].setRecentProject(addedProject);
    textInput.value = "";
    // testing
    for (let i = 0; i < _projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].projects.length; i++)
      console.log(_projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].projects[i].getName());
...
function submitTask() {
  ...
  const existingTaskNames = _projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].getRecentProject()
  ...
  if (
    ...
    if (formData[0][2].value !== "") {
      ...
      const addedTask = (0,_task__WEBPACK_IMPORTED_MODULE_0__["default"])(
        formData[0][0].value,
        formData[0][1].value,
        (0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(year, month, day), "MMM dd, yyyy"),
        formData[0][3].value
      );
      _projectManager__WEBPACK_IMPORTED_MODULE_2__["default"].getRecentProject().tasks.push(addedTask);
      for (let i = 0; i < 3; i++) {
        formData[0][i].value = "";
      }
